  ...
  <body>
    <div id="wrap">
      ...
      <div id="quick_btn">
        <ul class="q_list">
          <li>
            <a href="https://blog.naver.com/998hani" target="_blank">
              <img src="./images/q_blog.png" alt="" />
              <p>블로그</p>
            </a>
          </li>
          <li>
            <a href="https://buly.kr/uVKT7P" target="_blank">
              <img src="./images/q_naver.png" alt="" />
              <p>네이버 예약</p>
            </a>
          </li>
          <li>
            <a href="https://pf.kakao.com/_xeJKIG" target="_blank">
              <img src="./images/q_kakao.png" alt="" />
              <p>카카오톡 문의</p>
            </a>
          </li>
          <li>
            <a href="https://buly.kr/AwgWNdj" target="_blank">
              <img src="./images/q_ntalk.png" alt="" />
              <p>네이버 톡톡</p>
            </a>
          </li>
          <li>
            <a href="tel:051-752-9981">
              <img src="./images/q_tell.png" alt="" />
              <p>전화 문의</p>
            </a>
          </li>
          <li>
            <a href="https://buly.kr/B7bHMRS" target="_blank">
      ...
      <section id="sub_column_wrap">
        <div class="inner">
          <div class="title" data-aos="fade-up">
            <h2>998 <b>전문칼럼</b></h2>
            <p>
              맑은숲구구팔에서 전하는 한의학 기반 <br class="mob" />
              건강 정보와 전문 칼럼을 확인하실 수 있습니다.
            </p>
          </div>
          <!-- // title -->
